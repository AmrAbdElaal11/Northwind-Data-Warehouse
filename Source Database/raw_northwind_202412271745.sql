...
INSERT INTO categories (category_id,category_name,description,picture) VALUES
	 ...
	 (8,'Seafood','Seaweed and fish',decode('','hex')),
	 (1,'Beverages','Soft drinks, coffees, teas, beers, and ales',decode('','hex')),
	 (2,'Condiments','Sweet and savory sauces, relishes, spreads, and seasonings',decode('','hex'));
...
INSERT INTO customers (customer_id,company_name,contact_name,contact_title,address,city,region,postal_code,country,phone,fax) VALUES
	 ...
	 ('ALFKI','Alfreds Futterkiste','Maria Anders','Sales Representative','Obere Str. 57','Berlin','IncorrectRegion','12209','Germany','030-0074321','030-0076545');
INSERT INTO customers (customer_id,company_name,contact_name,contact_title,address,city,region,postal_code,country,phone,fax) VALUES
	 ('ANATR','Ana Trujillo Emparedados y helados','Ana Trujillo','Owner','Avda. de la Constitución 2222','México D.F.','IncorrectRegion','05021','Mexico','(5) 555-4729','(5) 555-3745'),
	 ('ALFKI','Alfreds Futterkiste','Maria Anders','Sales Representative','Obere Str. 57','Berlin','IncorrectRegion','12209','Germany','030-0074321','030-0076545'),
	 ('ANATR','Ana Trujillo Emparedados y helados','Ana Trujillo','Owner','Avda. de la Constitución 2222','México D.F.','IncorrectRegion','05021','Mexico','(5) 555-4729','(5) 555-3745'),
	 ('ANTON','Antonio Moreno Taquería','Antonio Moreno','Owner','Mataderos  2312','México D.F.',NULL,'05023','Mexico','(5) 555-3932',NULL),
	 ('AROUT','Around the Horn','Thomas Hardy','Sales Representative','120 Hanover Sq.','London',NULL,'WA1 1DP','UK','(171) 555-7788','(171) 555-6750'),
...
INSERT INTO employees (employee_id,last_name,first_name,title,title_of_courtesy,birth_date,hire_date,address,city,region,postal_code,country,home_phone,"extension",photo,notes,reports_to,photo_path) VALUES
	 ...
	 (9,'Dodsworth','Anne','Sales Representative','Ms.','1966-01-27','1994-11-15','7 Houndstooth Rd.','London',NULL,'WG2 7LT','UK','(71) 555-4444','452',decode('','hex'),'Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.',5,'http://accweb/emmployees/davolio.bmp'),
	 (1,'Davolio','Nancy','Sales Representative','Ms.','1948-12-08','1992-05-01','507 - 20th Ave. E.\nApt. 2A','Seattle','WA','98122','USA','(206) 555-9857','5467',decode('','hex'),'Education includes a BA in psychology from Colorado State University in 1970.  She also completed The Art of the Cold Call.  Nancy is a member of Toastmasters International.',2,'http://accweb/emmployees/davolio.bmp');
INSERT INTO employees (employee_id,last_name,first_name,title,title_of_courtesy,birth_date,hire_date,address,city,region,postal_code,country,home_phone,"extension",photo,notes,reports_to,photo_path) VALUES
	 (2,'Fuller','Andrew','Vice President, Sales','Dr.','1952-02-19','1992-08-14','908 W. Capital Way','Tacoma','WA','98401','USA','(206) 555-9482','3457',decode('','hex'),'Andrew received his BTS commercial in 1974 and a Ph.D. in international marketing from the University of Dallas in 1981.  He is fluent in French and Italian and reads German.  He joined the company as a sales representative, was promoted to sales manager in January 1992 and to vice president of sales in March 1993.  Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.',NULL,'http://accweb/emmployees/fuller.bmp'),
	 (3,'Leverling','Janet','Sales Representative','Ms.','1963-08-30','1992-04-01','722 Moss Bay Blvd.','Kirkland','WA','98033','USA','(206) 555-3412','3355',decode('','hex'),'Janet has a BS degree in chemistry from Boston College (1984).  She has also completed a certificate program in food retailing management.  Janet was hired as a sales associate in 1991 and promoted to sales representative in February 1992.',2,'http://accweb/emmployees/leverling.bmp'),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10267,59,44.0,70,0.15),
	 (10267,76,14.4,15,0.15),
	 (10268,29,99.0,10,0.0),
	 (10268,72,27.8,4,0.0),
	 (10269,33,2.0,60,0.05),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10303,68,10.0,15,0.1);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10304,49,16.0,30,0.0),
	 (10304,59,44.0,10,0.0),
	 (10304,71,17.2,2,0.0),
	 (10305,18,50.0,25,0.1),
	 (10305,29,99.0,25,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10334,52,5.6,8,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10334,68,10.0,10,0.0),
	 (10335,2,15.2,7,0.2),
	 (10335,31,10.0,25,0.2),
	 (10335,32,25.6,6,0.2),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10374,31,10.0,30,0.0),
	 (10374,58,10.6,15,0.0),
	 (10375,14,18.6,15,0.0),
	 (10375,54,5.9,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10376,31,10.0,42,0.05),
	 ...
	 (10380,60,27.2,6,0.1);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10380,70,12.0,30,0.0),
	 (10381,74,8.0,14,0.0),
	 (10382,5,17.0,32,0.0),
	 (10382,18,50.0,9,0.0),
	 (10382,29,99.0,14,0.0),
	 (10382,33,2.0,60,0.0),
	 (10382,74,8.0,50,0.0),
	 (10383,13,4.8,20,0.0),
	 (10383,50,13.0,15,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10389,70,12.0,30,0.0),
	 (10390,31,10.0,60,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10456,21,8.0,40,0.15),
	 (10456,49,16.0,21,0.15),
	 (10457,59,44.0,36,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10459,7,24.0,16,0.05),
	 (10459,46,9.6,20,0.05),
	 (10459,72,27.8,40,0.0),
	 (10460,68,10.0,21,0.25),
	 (10460,75,6.2,4,0.25),
	 (10461,21,8.0,40,0.25),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10465,24,3.6,25,0.0),
	 (10465,29,99.0,18,0.1),
	 (10465,40,14.7,20,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10465,45,7.6,30,0.1),
	 (10465,50,13.0,25,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10488,59,44.0,30,0.0),
	 (10488,73,12.0,20,0.2),
	 (10489,11,16.8,15,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10489,16,13.9,18,0.0),
	 (10490,59,44.0,60,0.0),
	 (10490,68,10.0,30,0.0),
	 (10490,75,6.2,36,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10519,10,31.0,16,0.05),
	 (10519,56,38.0,40,0.0),
	 (10519,60,34.0,10,0.05),
	 (10520,24,4.5,8,0.0),
	 (10520,53,32.8,5,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10521,35,18.0,3,0.0),
	 ...
	 (10523,17,39.0,25,0.1),
	 (10523,20,81.0,15,0.1),
	 (10523,37,26.0,18,0.1);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10523,41,9.65,6,0.1),
	 (10524,10,31.0,2,0.0),
	 (10524,30,25.89,10,0.0),
	 (10524,43,46.0,60,0.0),
	 (10524,54,7.45,15,0.0),
	 (10525,36,19.0,30,0.0),
	 (10525,40,18.4,15,0.1),
	 (10526,1,18.0,8,0.15),
	 (10526,13,6.0,10,0.0),
	 (10526,56,38.0,30,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10527,4,22.0,50,0.1),
	 (10527,36,19.0,30,0.1),
	 (10528,11,21.0,3,0.0),
	 (10528,33,2.5,8,0.2),
	 (10528,72,34.8,9,0.0),
	 (10529,55,24.0,14,0.0),
	 (10529,68,12.5,20,0.0),
	 (10529,69,36.0,10,0.0),
	 (10530,17,39.0,40,0.0),
	 (10530,43,46.0,25,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10530,61,28.5,20,0.0),
	 (10530,76,18.0,50,0.0),
	 (10531,59,55.0,2,0.0),
	 (10532,30,25.89,15,0.0),
	 (10532,66,17.0,24,0.0),
	 (10533,4,22.0,50,0.05),
	 (10533,72,34.8,24,0.0),
	 (10533,73,15.0,24,0.05),
	 (10534,30,25.89,10,0.0),
	 (10534,40,18.4,10,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10534,54,7.45,10,0.2),
	 (10535,11,21.0,50,0.1),
	 (10535,40,18.4,10,0.1),
	 (10535,57,19.5,5,0.1),
	 (10535,59,55.0,15,0.1),
	 (10536,12,38.0,15,0.25),
	 (10536,31,12.5,20,0.0),
	 (10536,33,2.5,30,0.0),
	 (10536,60,34.0,35,0.25),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10541,71,21.5,9,0.1),
	 (10542,11,21.0,15,0.05),
	 (10542,54,7.45,24,0.05);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10543,12,38.0,30,0.15),
	 (10543,23,9.0,70,0.15),
	 (10544,28,45.6,7,0.0),
	 (10544,67,14.0,7,0.0),
	 (10545,11,21.0,10,0.0),
	 (10546,7,30.0,10,0.0),
	 (10546,35,18.0,30,0.0),
	 (10546,62,49.3,40,0.0),
	 (10547,32,32.0,24,0.15),
	 (10547,36,19.0,60,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10548,34,14.0,10,0.25),
	 (10548,41,9.65,14,0.0),
	 (10549,31,12.5,55,0.15),
	 (10549,45,9.5,100,0.15),
	 (10549,51,53.0,48,0.15),
	 (10550,17,39.0,8,0.1),
	 (10550,19,9.2,10,0.0),
	 (10550,21,10.0,6,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10575,59,55.0,12,0.0),
	 (10575,63,43.9,6,0.0),
	 (10575,72,34.8,30,0.0),
	 (10575,76,18.0,10,0.0),
	 (10576,1,18.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10576,31,12.5,20,0.0),
	 (10576,44,19.45,21,0.0),
	 (10577,39,18.0,10,0.0),
	 (10577,75,7.75,20,0.0),
	 (10577,77,13.0,18,0.0),
	 (10578,35,18.0,20,0.0),
	 (10578,57,19.5,6,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10582,57,19.5,4,0.0),
	 (10582,76,18.0,14,0.0),
	 (10583,29,123.79,10,0.0),
	 (10583,60,34.0,24,0.15),
	 (10583,69,36.0,10,0.15),
	 (10584,31,12.5,50,0.05),
	 (10585,47,9.5,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10586,52,7.0,4,0.15),
	 (10587,26,31.23,6,0.0),
	 (10587,35,18.0,20,0.0),
	 (10587,77,13.0,20,0.0),
	 (10588,18,62.5,40,0.2),
	 (10588,42,14.0,100,0.2),
	 (10589,35,18.0,4,0.0),
	 (10590,1,18.0,20,0.0),
	 (10590,77,13.0,60,0.05),
	 (10591,3,10.0,14,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10591,7,30.0,10,0.0),
	 ...
	 (10593,20,81.0,21,0.2),
	 (10593,69,36.0,20,0.2),
	 (10593,76,18.0,4,0.2),
	 (10594,52,7.0,24,0.0),
	 (10594,58,13.25,30,0.0),
	 (10595,35,18.0,30,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10595,61,28.5,120,0.25),
	 (10595,69,36.0,65,0.25),
	 (10596,56,38.0,5,0.2),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10600,54,7.45,4,0.0),
	 (10600,73,15.0,30,0.0),
	 (10601,13,6.0,60,0.0),
	 (10601,59,55.0,35,0.0),
	 (10602,77,13.0,5,0.25),
	 (10603,22,21.0,48,0.0),
	 (10603,49,20.0,25,0.05),
	 (10604,48,12.75,6,0.1),
	 (10604,76,18.0,10,0.1);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10605,16,17.45,30,0.05),
	 (10605,59,55.0,20,0.05),
	 (10605,60,34.0,70,0.05),
	 (10605,71,21.5,15,0.05),
	 (10606,4,22.0,20,0.2),
	 (10606,55,24.0,20,0.2),
	 (10606,62,49.3,10,0.2),
	 (10607,7,30.0,45,0.0),
	 (10607,17,39.0,100,0.0),
	 (10607,33,2.5,14,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10607,40,18.4,42,0.0),
	 (10607,72,34.8,12,0.0),
	 (10608,56,38.0,28,0.0),
	 (10609,1,18.0,3,0.0),
	 (10609,10,31.0,10,0.0),
	 (10609,21,10.0,6,0.0),
	 (10610,36,19.0,21,0.25),
	 (10611,1,18.0,6,0.0),
	 (10611,2,19.0,10,0.0),
	 (10611,60,34.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10612,10,31.0,70,0.0),
	 (10612,36,19.0,55,0.0),
	 (10612,49,20.0,18,0.0),
	 (10612,60,34.0,40,0.0),
	 (10612,76,18.0,80,0.0),
	 (10613,13,6.0,8,0.1),
	 (10613,75,7.75,40,0.0),
	 (10614,11,21.0,14,0.0),
	 (10614,21,10.0,8,0.0),
	 (10614,39,18.0,5,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10615,55,24.0,5,0.0),
	 (10616,38,263.5,15,0.05),
	 (10616,56,38.0,14,0.0),
	 (10616,70,15.0,15,0.05),
	 (10616,71,21.5,15,0.05),
	 (10617,59,55.0,30,0.15),
	 (10618,6,25.0,70,0.0),
	 (10618,56,38.0,20,0.0),
	 (10618,68,12.5,15,0.0),
	 (10619,21,10.0,42,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10619,22,21.0,40,0.0),
	 (10620,24,4.5,5,0.0),
	 (10620,52,7.0,5,0.0),
	 (10621,19,9.2,5,0.0),
	 (10621,23,9.0,10,0.0),
	 (10621,70,15.0,20,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10623,19,9.2,15,0.1),
	 (10623,21,10.0,25,0.1),
	 (10623,24,4.5,3,0.0),
	 (10623,35,18.0,30,0.1),
	 (10624,28,45.6,10,0.0),
	 (10624,29,123.79,6,0.0),
	 (10624,44,19.45,10,0.0),
	 (10625,14,23.25,3,0.0),
	 (10625,42,14.0,5,0.0),
	 (10625,60,34.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10626,53,32.8,12,0.0),
	 (10626,60,34.0,20,0.0),
	 (10626,71,21.5,20,0.0),
	 (10627,62,49.3,15,0.0),
	 (10627,73,15.0,35,0.15),
	 (10628,1,18.0,25,0.0),
	 (10629,29,123.79,20,0.0),
	 (10629,64,33.25,9,0.0),
	 (10630,55,24.0,12,0.05),
	 (10630,76,18.0,35,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10631,75,7.75,8,0.1),
	 (10632,2,19.0,30,0.05),
	 (10632,33,2.5,20,0.05),
	 (10633,12,38.0,36,0.15),
	 (10633,13,6.0,13,0.15),
	 (10633,26,31.23,35,0.15),
	 (10633,62,49.3,80,0.15),
	 (10634,7,30.0,35,0.0),
	 (10634,18,62.5,50,0.0),
	 (10634,51,53.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10634,75,7.75,2,0.0),
	 (10635,4,22.0,10,0.1),
	 (10635,5,21.35,15,0.1),
	 (10635,22,21.0,40,0.0),
	 (10636,4,22.0,25,0.0),
	 (10636,58,13.25,6,0.0),
	 (10637,11,21.0,10,0.0),
	 (10637,50,16.25,25,0.05),
	 (10637,56,38.0,60,0.05),
	 (10638,45,9.5,20,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10638,65,21.05,21,0.0),
	 (10638,72,34.8,60,0.0),
	 (10639,18,62.5,8,0.0),
	 (10640,69,36.0,20,0.25),
	 (10640,70,15.0,15,0.25),
	 (10641,2,19.0,50,0.0),
	 (10641,40,18.4,60,0.0),
	 (10642,21,10.0,30,0.2),
	 (10642,61,28.5,20,0.2),
	 (10643,28,45.6,15,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10643,39,18.0,21,0.25),
	 (10643,46,12.0,2,0.25),
	 (10644,18,62.5,4,0.1),
	 (10644,43,46.0,20,0.0),
	 (10644,46,12.0,21,0.1),
	 (10645,18,62.5,20,0.0),
	 (10645,36,19.0,15,0.0),
	 (10646,1,18.0,15,0.25),
	 (10646,10,31.0,18,0.25),
	 (10646,71,21.5,30,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10646,77,13.0,35,0.25),
	 (10647,19,9.2,30,0.0),
	 (10647,39,18.0,20,0.0),
	 (10648,22,21.0,15,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10651,22,21.0,20,0.25),
	 (10652,30,25.89,2,0.25),
	 (10652,42,14.0,20,0.0),
	 (10653,16,17.45,30,0.1),
	 (10653,60,34.0,20,0.1),
	 (10654,4,22.0,12,0.1),
	 (10654,39,18.0,20,0.1),
	 (10654,54,7.45,6,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10657,46,12.0,45,0.0),
	 (10657,47,9.5,10,0.0),
	 (10657,56,38.0,45,0.0),
	 (10657,60,34.0,30,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10659,70,15.0,40,0.05),
	 (10660,20,81.0,21,0.0),
	 (10661,39,18.0,3,0.2),
	 (10661,58,13.25,49,0.2),
	 (10662,68,12.5,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10663,40,18.4,30,0.05),
	 (10663,42,14.0,30,0.05),
	 (10663,51,53.0,20,0.05),
	 (10664,10,31.0,24,0.15),
	 (10664,56,38.0,12,0.15),
	 (10664,65,21.05,15,0.15),
	 (10665,51,53.0,20,0.0),
	 (10665,59,55.0,1,0.0),
	 (10665,76,18.0,10,0.0),
	 (10666,29,123.79,36,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10666,65,21.05,10,0.0),
	 (10667,69,36.0,45,0.2),
	 (10667,71,21.5,14,0.2),
	 (10668,31,12.5,8,0.1),
	 (10668,55,24.0,4,0.1),
	 (10668,64,33.25,15,0.1),
	 (10669,36,19.0,30,0.0),
	 (10670,23,9.0,32,0.0),
	 (10670,46,12.0,60,0.0),
	 (10670,67,14.0,25,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10670,73,15.0,50,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10684,47,9.5,40,0.0),
	 (10684,60,34.0,30,0.0),
	 (10685,10,31.0,20,0.0),
	 (10685,41,9.65,4,0.0),
	 (10685,47,9.5,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10686,17,39.0,30,0.2),
	 (10686,26,31.23,15,0.0),
	 (10687,9,97.0,50,0.25),
	 (10687,29,123.79,10,0.0),
	 (10687,36,19.0,6,0.25),
	 (10688,10,31.0,18,0.1),
	 (10688,28,45.6,60,0.1),
	 (10688,34,14.0,14,0.0),
	 (10689,1,18.0,35,0.25),
	 (10690,56,38.0,20,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10690,77,13.0,30,0.25),
	 (10691,1,18.0,30,0.0),
	 (10691,29,123.79,40,0.0),
	 (10691,43,46.0,40,0.0),
	 (10691,44,19.45,24,0.0),
	 (10691,62,49.3,48,0.0),
	 (10692,63,43.9,20,0.0),
	 (10693,9,97.0,6,0.0),
	 (10693,54,7.45,60,0.15),
	 (10693,69,36.0,30,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10693,73,15.0,15,0.15),
	 (10694,7,30.0,90,0.0),
	 (10694,59,55.0,25,0.0),
	 (10694,70,15.0,50,0.0),
	 (10695,8,40.0,10,0.0),
	 (10695,12,38.0,4,0.0),
	 (10695,24,4.5,20,0.0),
	 (10696,17,39.0,20,0.0),
	 (10696,46,12.0,18,0.0),
	 (10697,19,9.2,7,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10697,35,18.0,9,0.25),
	 (10697,58,13.25,30,0.25),
	 (10697,70,15.0,30,0.25),
	 (10698,11,21.0,15,0.0),
	 (10698,17,39.0,8,0.05),
	 (10698,29,123.79,12,0.05),
	 (10698,65,21.05,65,0.05),
	 (10698,70,15.0,8,0.05),
	 (10699,47,9.5,12,0.0),
	 (10700,1,18.0,5,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10700,34,14.0,12,0.2),
	 (10700,68,12.5,40,0.2),
	 (10700,71,21.5,60,0.2),
	 (10701,59,55.0,42,0.15),
	 (10701,71,21.5,20,0.15),
	 (10701,76,18.0,35,0.15),
	 (10702,3,10.0,6,0.0),
	 (10702,76,18.0,15,0.0),
	 (10703,2,19.0,5,0.0),
	 (10703,59,55.0,35,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10703,73,15.0,35,0.0),
	 (10704,4,22.0,6,0.0),
	 (10704,24,4.5,35,0.0),
	 ...
	 (10706,43,46.0,24,0.0),
	 (10706,59,55.0,8,0.0),
	 (10707,55,24.0,21,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10707,57,19.5,40,0.0),
	 (10707,70,15.0,28,0.15),
	 (10708,5,21.35,4,0.0),
	 (10708,36,19.0,5,0.0),
	 (10709,8,40.0,40,0.0),
	 (10709,51,53.0,28,0.0),
	 (10709,60,34.0,10,0.0),
	 (10710,19,9.2,5,0.0),
	 (10710,47,9.5,5,0.0),
	 (10711,19,9.2,12,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10726,4,22.0,25,0.0),
	 (10726,11,21.0,5,0.0),
	 (10727,17,39.0,20,0.05),
	 (10727,56,38.0,10,0.05),
	 (10727,59,55.0,10,0.05),
	 (10728,30,25.89,15,0.0),
	 (10728,40,18.4,6,0.0),
	 (10728,55,24.0,12,0.0),
	 (10728,60,34.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10729,1,18.0,50,0.0),
	 (10729,21,10.0,30,0.0),
	 (10729,50,16.25,40,0.0),
	 (10730,16,17.45,15,0.05),
	 (10730,31,12.5,3,0.05),
	 (10730,65,21.05,10,0.05),
	 (10731,21,10.0,40,0.05),
	 (10731,51,53.0,30,0.05),
	 (10732,76,18.0,20,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10739,52,7.0,18,0.0),
	 (10740,28,45.6,5,0.2),
	 (10740,35,18.0,35,0.2),
	 (10740,45,9.5,40,0.2),
	 (10740,56,38.0,14,0.2),
	 (10741,2,19.0,15,0.2),
	 (10742,3,10.0,20,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10742,60,34.0,50,0.0),
	 (10742,72,34.8,35,0.0),
	 (10743,46,12.0,28,0.05),
	 (10744,40,18.4,50,0.2),
	 (10745,18,62.5,24,0.0),
	 (10745,44,19.45,16,0.0),
	 (10745,59,55.0,45,0.0),
	 (10745,72,34.8,7,0.0),
	 (10746,13,6.0,6,0.0),
	 (10746,42,14.0,28,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10746,62,49.3,9,0.0),
	 (10746,69,36.0,40,0.0),
	 (10747,31,12.5,8,0.0),
	 (10747,41,9.65,35,0.0),
	 (10747,63,43.9,9,0.0),
	 (10747,69,36.0,30,0.0),
	 (10748,23,9.0,44,0.0),
	 (10748,40,18.4,40,0.0),
	 (10748,56,38.0,28,0.0),
	 (10749,56,38.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10749,59,55.0,6,0.0),
	 (10749,76,18.0,10,0.0),
	 (10750,14,23.25,5,0.15),
	 (10750,45,9.5,40,0.15),
	 (10750,59,55.0,25,0.15),
	 (10751,26,31.23,12,0.1),
	 (10751,30,25.89,30,0.0),
	 (10751,50,16.25,20,0.1),
	 (10751,73,15.0,15,0.0),
	 (10752,1,18.0,8,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10752,69,36.0,3,0.0),
	 (10753,45,9.5,4,0.0),
	 ...
	 (10755,56,38.0,30,0.25),
	 (10755,57,19.5,14,0.25),
	 (10755,69,36.0,25,0.25),
	 (10756,18,62.5,21,0.2),
	 (10756,36,19.0,20,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10756,68,12.5,6,0.2),
	 (10756,69,36.0,20,0.2),
	 (10757,34,14.0,30,0.0),
	 (10757,59,55.0,7,0.0),
	 (10757,62,49.3,30,0.0),
	 (10757,64,33.25,24,0.0),
	 (10758,26,31.23,20,0.0),
	 (10758,52,7.0,60,0.0),
	 (10758,70,15.0,40,0.0),
	 (10759,32,32.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10760,25,14.0,12,0.25),
	 (10760,27,43.9,40,0.0),
	 (10760,43,46.0,30,0.25),
	 (10761,25,14.0,35,0.25),
	 (10761,75,7.75,18,0.0),
	 (10762,39,18.0,16,0.0),
	 (10762,47,9.5,30,0.0),
	 (10762,51,53.0,28,0.0),
	 (10762,56,38.0,60,0.0),
	 (10763,21,10.0,40,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10763,22,21.0,6,0.0),
	 (10763,24,4.5,20,0.0),
	 (10764,3,10.0,20,0.1),
	 (10764,39,18.0,130,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10795,17,39.0,35,0.25),
	 (10796,26,31.23,21,0.2),
	 (10796,44,19.45,10,0.0),
	 (10796,64,33.25,35,0.2),
	 (10796,69,36.0,24,0.2),
	 (10797,11,21.0,20,0.0),
	 (10798,62,49.3,2,0.0),
	 (10798,72,34.8,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10799,13,6.0,20,0.15),
	 (10799,24,4.5,20,0.15),
	 (10799,59,55.0,25,0.0),
	 (10800,11,21.0,50,0.1),
	 (10800,51,53.0,10,0.1),
	 (10800,54,7.45,7,0.1),
	 (10801,17,39.0,40,0.25),
	 (10801,29,123.79,20,0.25),
	 (10802,30,25.89,25,0.25),
	 (10802,51,53.0,30,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10802,55,24.0,60,0.25),
	 (10802,62,49.3,5,0.25),
	 (10803,19,9.2,24,0.05),
	 (10803,25,14.0,15,0.05),
	 (10803,59,55.0,15,0.05),
	 (10804,10,31.0,36,0.0),
	 (10804,28,45.6,24,0.0),
	 (10804,49,20.0,4,0.15),
	 (10805,34,14.0,10,0.0),
	 (10805,38,263.5,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10806,2,19.0,20,0.25),
	 (10806,65,21.05,2,0.0),
	 (10806,74,10.0,15,0.25),
	 (10807,40,18.4,1,0.0),
	 (10808,56,38.0,20,0.15),
	 (10808,76,18.0,50,0.15),
	 (10809,52,7.0,20,0.0),
	 (10810,13,6.0,7,0.0),
	 (10810,25,14.0,5,0.0),
	 (10810,70,15.0,5,0.0);
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10822,62,49.3,3,0.0),
	 (10822,70,15.0,6,0.0),
	 (10823,11,21.0,20,0.1),
	 (10823,57,19.5,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10823,59,55.0,40,0.1),
	 (10823,77,13.0,15,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10845,23,9.0,70,0.1),
	 (10845,35,18.0,25,0.1),
	 (10845,42,14.0,42,0.1),
	 (10845,58,13.25,60,0.1),
	 (10845,64,33.25,48,0.0),
	 (10846,4,22.0,21,0.0),
	 (10846,70,15.0,30,0.0),
	 (10846,74,10.0,20,0.0),
	 (10847,1,18.0,80,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10847,19,9.2,12,0.2),
	 (10847,37,26.0,60,0.2),
	 (10847,45,9.5,36,0.2),
	 (10847,60,34.0,45,0.2),
	 (10847,71,21.5,55,0.2),
	 (10848,5,21.35,30,0.0),
	 (10848,9,97.0,3,0.0),
	 (10849,3,10.0,49,0.0),
	 (10849,26,31.23,18,0.15),
	 (10850,25,14.0,20,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10850,33,2.5,4,0.15),
	 (10850,70,15.0,30,0.15),
	 (10851,2,19.0,5,0.05),
	 (10851,25,14.0,10,0.05),
	 (10851,57,19.5,10,0.05),
	 (10851,59,55.0,42,0.05),
	 (10852,2,19.0,15,0.0),
	 (10852,17,39.0,6,0.0),
	 (10852,62,49.3,50,0.0),
	 (10853,18,62.5,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10854,10,31.0,100,0.15),
	 (10854,13,6.0,65,0.15),
	 (10855,16,17.45,50,0.0),
	 (10855,31,12.5,14,0.0),
	 (10855,56,38.0,24,0.0),
	 (10855,65,21.05,15,0.15),
	 (10856,2,19.0,20,0.0),
	 (10856,42,14.0,20,0.0),
	 (10857,3,10.0,30,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10860,51,53.0,3,0.0),
	 (10860,76,18.0,20,0.0),
	 (10861,17,39.0,42,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10861,18,62.5,20,0.0),
	 (10861,21,10.0,40,0.0),
	 (10861,33,2.5,35,0.0),
	 (10861,62,49.3,3,0.0),
	 (10862,11,21.0,25,0.0),
	 (10862,52,7.0,8,0.0),
	 (10863,1,18.0,20,0.15),
	 (10863,58,13.25,12,0.15),
	 (10864,35,18.0,4,0.0),
	 (10864,67,14.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10865,38,263.5,60,0.05),
	 (10865,39,18.0,80,0.05),
	 (10866,2,19.0,21,0.25),
	 (10866,24,4.5,6,0.25),
	 (10866,30,25.89,40,0.25),
	 (10867,53,32.8,3,0.0),
	 (10868,26,31.23,20,0.0),
	 (10868,35,18.0,30,0.0),
	 (10868,49,20.0,42,0.1),
	 (10869,1,18.0,40,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10869,11,21.0,10,0.0),
	 (10869,23,9.0,50,0.0),
	 (10869,68,12.5,20,0.0),
	 (10870,35,18.0,3,0.0),
	 (10870,51,53.0,2,0.0),
	 (10871,6,25.0,50,0.05),
	 (10871,16,17.45,12,0.05),
	 (10871,17,39.0,16,0.05),
	 (10872,55,24.0,10,0.05),
	 (10872,62,49.3,20,0.05);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10872,64,33.25,15,0.05),
	 (10872,65,21.05,21,0.05),
	 (10873,21,10.0,20,0.0),
	 (10873,28,45.6,3,0.0),
	 (10874,10,31.0,10,0.0),
	 (10875,19,9.2,25,0.0),
	 (10875,47,9.5,21,0.1),
	 (10875,49,20.0,15,0.0),
	 (10876,46,12.0,21,0.0),
	 (10876,64,33.25,20,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10877,16,17.45,30,0.25),
	 (10877,18,62.5,25,0.0),
	 (10878,20,81.0,20,0.05),
	 (10879,40,18.4,12,0.0),
	 (10879,65,21.05,10,0.0),
	 (10879,76,18.0,10,0.0),
	 (10880,23,9.0,30,0.2),
	 (10880,61,28.5,30,0.2),
	 (10880,70,15.0,50,0.2),
	 (10881,73,15.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10882,42,14.0,25,0.0),
	 (10882,49,20.0,20,0.15),
	 (10882,54,7.45,32,0.15),
	 (10883,24,4.5,8,0.0),
	 (10884,21,10.0,40,0.05),
	 (10884,56,38.0,21,0.05),
	 (10884,65,21.05,12,0.05),
	 (10885,2,19.0,20,0.0),
	 (10885,24,4.5,12,0.0),
	 (10885,70,15.0,30,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10885,77,13.0,25,0.0),
	 (10886,10,31.0,70,0.0),
	 (10886,31,12.5,35,0.0),
	 (10886,77,13.0,40,0.0),
	 (10887,25,14.0,5,0.0),
	 (10888,2,19.0,20,0.0),
	 (10888,68,12.5,18,0.0),
	 (10889,11,21.0,40,0.0),
	 (10889,38,263.5,40,0.0),
	 (10890,17,39.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10890,34,14.0,10,0.0),
	 (10890,41,9.65,14,0.0),
	 (10891,30,25.89,15,0.05),
	 (10892,59,55.0,40,0.05),
	 (10893,8,40.0,30,0.0),
	 (10893,24,4.5,10,0.0),
	 (10893,29,123.79,24,0.0),
	 (10893,30,25.89,35,0.0),
	 (10893,36,19.0,20,0.0),
	 (10894,13,6.0,28,0.05);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10894,69,36.0,50,0.05),
	 (10894,75,7.75,120,0.05),
	 (10895,24,4.5,110,0.0),
	 (10895,39,18.0,45,0.0),
	 (10895,40,18.4,91,0.0),
	 (10895,60,34.0,100,0.0),
	 (10896,45,9.5,15,0.0),
	 (10896,56,38.0,16,0.0),
	 (10897,29,123.79,80,0.0),
	 (10897,30,25.89,36,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10898,13,6.0,5,0.0),
	 (10899,39,18.0,8,0.15),
	 (10900,70,15.0,3,0.25),
	 (10901,41,9.65,30,0.0),
	 (10901,71,21.5,30,0.0),
	 (10902,55,24.0,30,0.15),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10905,1,18.0,20,0.05),
	 (10906,61,28.5,15,0.0),
	 (10907,75,7.75,14,0.0),
	 (10908,7,30.0,20,0.05),
	 (10908,52,7.0,14,0.05),
	 (10909,7,30.0,12,0.0),
	 (10909,16,17.45,15,0.0),
	 (10909,41,9.65,5,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10910,19,9.2,12,0.0),
	 (10910,49,20.0,10,0.0),
	 (10910,61,28.5,5,0.0),
	 (10911,1,18.0,10,0.0),
	 (10911,17,39.0,12,0.0),
	 (10911,67,14.0,15,0.0),
	 (10912,11,21.0,40,0.25),
	 (10912,29,123.79,60,0.25),
	 (10913,4,22.0,30,0.25),
	 (10913,33,2.5,40,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10913,58,13.25,15,0.0),
	 (10914,71,21.5,25,0.0),
	 (10915,17,39.0,10,0.0),
	 (10915,33,2.5,30,0.0),
	 ...
	 (10917,60,34.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10918,1,18.0,60,0.25),
	 (10918,60,34.0,25,0.25),
	 (10919,16,17.45,24,0.0),
	 (10919,25,14.0,24,0.0),
	 (10919,40,18.4,20,0.0),
	 (10920,50,16.25,24,0.0),
	 (10921,35,18.0,10,0.0),
	 (10921,63,43.9,40,0.0),
	 (10922,17,39.0,15,0.0),
	 (10922,24,4.5,35,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10923,42,14.0,10,0.2),
	 (10923,43,46.0,10,0.2),
	 (10923,67,14.0,24,0.2),
	 (10924,10,31.0,20,0.1),
	 (10924,28,45.6,30,0.1),
	 (10924,75,7.75,6,0.0),
	 (10925,36,19.0,25,0.15),
	 (10925,52,7.0,12,0.15),
	 (10926,11,21.0,2,0.0),
	 (10926,13,6.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10926,19,9.2,7,0.0),
	 ...
	 (10927,20,81.0,5,0.0),
	 (10927,52,7.0,5,0.0),
	 (10927,76,18.0,20,0.0),
	 (10928,47,9.5,5,0.0),
	 (10928,76,18.0,5,0.0),
	 (10929,21,10.0,60,0.0),
	 (10929,75,7.75,49,0.0),
	 (10929,77,13.0,15,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10930,21,10.0,36,0.0),
	 (10930,27,43.9,25,0.0),
	 (10930,55,24.0,25,0.2),
	 (10930,58,13.25,30,0.2),
	 (10931,13,6.0,42,0.15),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10935,23,9.0,8,0.25),
	 (10936,36,19.0,30,0.2),
	 (10937,28,45.6,8,0.0),
	 (10937,34,14.0,20,0.0),
	 (10938,13,6.0,20,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10938,43,46.0,24,0.25),
	 (10938,60,34.0,49,0.25),
	 (10938,71,21.5,35,0.25),
	 (10939,2,19.0,10,0.15),
	 (10939,67,14.0,40,0.15),
	 (10940,7,30.0,8,0.0),
	 (10940,13,6.0,20,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10942,49,20.0,28,0.0),
	 (10943,13,6.0,15,0.0),
	 (10943,22,21.0,21,0.0),
	 (10943,46,12.0,15,0.0),
	 (10944,11,21.0,5,0.25),
	 (10944,44,19.45,18,0.25),
	 (10944,56,38.0,18,0.0),
	 (10945,13,6.0,20,0.0),
	 (10945,31,12.5,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10946,10,31.0,25,0.0),
	 (10946,24,4.5,25,0.0),
	 (10946,77,13.0,40,0.0),
	 (10947,59,55.0,4,0.0),
	 (10948,50,16.25,9,0.0),
	 (10948,51,53.0,40,0.0),
	 (10948,55,24.0,4,0.0),
	 (10949,6,25.0,12,0.0),
	 (10949,10,31.0,30,0.0),
	 (10949,17,39.0,6,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10961,52,7.0,6,0.05),
	 (10961,76,18.0,60,0.0),
	 (10962,7,30.0,45,0.0),
	 (10962,13,6.0,77,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10962,53,32.8,20,0.0),
	 (10962,69,36.0,9,0.0),
	 (10962,76,18.0,44,0.0),
	 (10963,60,34.0,2,0.15),
	 (10964,18,62.5,6,0.0),
	 (10964,38,263.5,5,0.0),
	 (10964,69,36.0,10,0.0),
	 (10965,51,53.0,16,0.0),
	 (10966,37,26.0,8,0.0),
	 (10966,56,38.0,12,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10966,62,49.3,12,0.15),
	 (10967,19,9.2,12,0.0),
	 (10967,49,20.0,40,0.0),
	 (10968,12,38.0,30,0.0),
	 (10968,24,4.5,30,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10977,39,18.0,30,0.0),
	 (10977,47,9.5,30,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10977,51,53.0,10,0.0),
	 (10977,63,43.9,20,0.0),
	 (10978,8,40.0,20,0.15),
	 (10978,21,10.0,40,0.15),
	 (10978,40,18.4,10,0.0),
	 (10978,44,19.45,6,0.15),
	 (10979,7,30.0,18,0.0),
	 (10979,12,38.0,20,0.0),
	 (10979,24,4.5,80,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10982,7,30.0,20,0.0),
	 (10982,43,46.0,9,0.0),
	 (10983,13,6.0,84,0.15),
	 (10983,57,19.5,15,0.0),
	 (10984,16,17.45,55,0.0),
	 (10984,24,4.5,20,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10984,36,19.0,40,0.0),
	 (10985,16,17.45,36,0.1),
	 (10985,18,62.5,8,0.1),
	 (10985,32,32.0,35,0.1),
	 (10986,11,21.0,30,0.0),
	 (10986,20,81.0,15,0.0),
	 (10986,76,18.0,10,0.0),
	 (10986,77,13.0,15,0.0),
	 (10987,7,30.0,60,0.0),
	 (10987,43,46.0,6,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (10989,6,25.0,40,0.0),
	 (10989,11,21.0,15,0.0),
	 (10989,41,9.65,4,0.0),
	 (10990,21,10.0,65,0.0),
	 (10990,34,14.0,60,0.15),
	 (10990,55,24.0,65,0.15),
	 (10990,61,28.5,66,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10991,2,19.0,50,0.2),
	 (10991,70,15.0,20,0.2),
	 (10991,76,18.0,90,0.2),
	 (10992,72,34.8,2,0.0),
	 (10993,29,123.79,50,0.25),
	 (10993,41,9.65,35,0.25),
	 (10994,59,55.0,18,0.05),
	 (10995,51,53.0,20,0.0),
	 (10995,60,34.0,4,0.0),
	 (10996,42,14.0,40,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (10997,32,32.0,50,0.0),
	 (10997,46,12.0,20,0.25),
	 (10997,52,7.0,20,0.25),
	 (10998,24,4.5,12,0.0),
	 (10998,61,28.5,7,0.0),
	 (10998,74,10.0,20,0.0),
	 (10998,75,7.75,30,0.0),
	 (10999,41,9.65,20,0.05),
	 (10999,51,53.0,15,0.05),
	 (10999,77,13.0,21,0.05);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11000,4,22.0,25,0.25),
	 (11000,24,4.5,30,0.25),
	 (11000,77,13.0,30,0.0),
	 (11001,7,30.0,60,0.0),
	 (11001,22,21.0,25,0.0),
	 (11001,46,12.0,25,0.0),
	 (11001,55,24.0,6,0.0),
	 (11002,13,6.0,56,0.0),
	 (11002,35,18.0,15,0.15),
	 (11002,42,14.0,24,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11002,55,24.0,40,0.0),
	 (11003,1,18.0,4,0.0),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (11015,77,13.0,18,0.0),
	 (11016,31,12.5,15,0.0),
	 (11016,36,19.0,16,0.0),
	 (11017,3,10.0,25,0.0),
	 (11017,59,55.0,110,0.0),
	 (11017,70,15.0,30,0.0),
	 (11018,12,38.0,20,0.0),
	 (11018,18,62.5,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11018,56,38.0,5,0.0),
	 (11019,46,12.0,3,0.0),
	 (11019,49,20.0,2,0.0),
	 (11020,10,31.0,24,0.15),
	 (11021,2,19.0,11,0.25),
	 (11021,20,81.0,15,0.0),
	 (11021,26,31.23,63,0.0),
	 (11021,51,53.0,44,0.25),
	 (11021,72,34.8,35,0.0),
	 (11022,19,9.2,35,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11022,69,36.0,30,0.0),
	 (11023,7,30.0,4,0.0),
	 (11023,43,46.0,30,0.0),
	 ...
	 (11026,18,62.5,8,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11026,51,53.0,10,0.0),
	 (11027,24,4.5,30,0.25),
	 (11027,62,49.3,21,0.25),
	 (11028,55,24.0,35,0.0),
	 (11028,59,55.0,24,0.0),
	 (11029,56,38.0,20,0.0),
	 (11029,63,43.9,12,0.0),
	 (11030,2,19.0,100,0.25),
	 (11030,5,21.35,70,0.0),
	 (11030,29,123.79,60,0.25);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11030,59,55.0,100,0.25),
	 (11031,1,18.0,45,0.0),
	 (11031,13,6.0,80,0.0),
	 (11031,24,4.5,21,0.0),
	 (11031,64,33.25,20,0.0),
	 (11031,71,21.5,16,0.0),
	 (11032,36,19.0,35,0.0),
	 (11032,38,263.5,25,0.0),
	 (11032,59,55.0,30,0.0),
	 (11033,53,32.8,70,0.1);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11033,69,36.0,36,0.1),
	 (11034,21,10.0,15,0.1),
	 (11034,44,19.45,12,0.0),
	 (11034,61,28.5,6,0.0),
	 (11035,1,18.0,10,0.0),
	 (11035,35,18.0,60,0.0),
	 (11035,42,14.0,30,0.0),
	 (11035,54,7.45,10,0.0),
	 (11036,13,6.0,7,0.0),
	 (11036,59,55.0,30,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11037,70,15.0,4,0.0),
	 (11038,40,18.4,5,0.2),
	 (11038,52,7.0,2,0.0),
	 ...
	 (11039,35,18.0,24,0.0),
	 (11039,49,20.0,60,0.0),
	 (11039,57,19.5,28,0.0),
	 (11040,21,10.0,20,0.0),
	 (11041,2,19.0,30,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11041,63,43.9,30,0.0),
	 (11042,44,19.45,15,0.0),
	 (11042,61,28.5,4,0.0),
	 (11043,11,21.0,10,0.0),
	 (11044,62,49.3,12,0.0),
	 (11045,33,2.5,15,0.0),
	 (11045,51,53.0,24,0.0),
	 (11046,12,38.0,20,0.05),
	 (11046,32,32.0,15,0.05),
	 (11046,35,18.0,18,0.05);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11047,1,18.0,25,0.25),
	 (11047,5,21.35,30,0.25),
	 (11048,68,12.5,42,0.0),
	 (11049,2,19.0,10,0.2),
	 (11049,12,38.0,4,0.2),
	 (11050,76,18.0,50,0.1),
	 (11051,24,4.5,10,0.2),
	 (11052,43,46.0,30,0.2),
	 (11052,61,28.5,10,0.2),
	 (11053,18,62.5,35,0.2);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11053,32,32.0,20,0.0),
	 (11053,64,33.25,25,0.2),
	 (11054,33,2.5,10,0.0),
	 (11054,67,14.0,20,0.0),
	 (11055,24,4.5,15,0.0),
	 (11055,25,14.0,15,0.0),
	 (11055,51,53.0,20,0.0),
	 (11055,57,19.5,20,0.0),
	 (11056,7,30.0,40,0.0),
	 (11056,55,24.0,35,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11056,60,34.0,50,0.0),
	 (11057,70,15.0,3,0.0),
	 (11058,21,10.0,3,0.0),
	 (11058,60,34.0,21,0.0),
	 (11058,61,28.5,4,0.0),
	 (11059,13,6.0,30,0.0),
	 (11059,17,39.0,12,0.0),
	 (11059,60,34.0,35,0.0),
	 (11060,60,34.0,4,0.0),
	 (11060,77,13.0,10,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11061,60,34.0,15,0.0),
	 (11062,53,32.8,10,0.2),
	 (11062,70,15.0,12,0.2),
	 (11063,34,14.0,30,0.0),
	 (11063,40,18.4,40,0.1),
	 (11063,41,9.65,30,0.1),
	 (11064,17,39.0,77,0.1),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (11066,19,9.2,42,0.0),
	 (11066,34,14.0,35,0.0),
	 (11067,41,9.65,9,0.0),
	 (11068,28,45.6,8,0.15),
	 (11068,43,46.0,36,0.15),
	 (11068,77,13.0,28,0.15);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11069,39,18.0,20,0.0),
	 (11070,1,18.0,40,0.15),
	 (11070,2,19.0,20,0.15),
	 (11070,16,17.45,30,0.15),
	 (11070,31,12.5,20,0.0),
	 (11071,7,30.0,15,0.05),
	 (11071,13,6.0,10,0.05),
	 (11072,2,19.0,8,0.0),
	 (11072,41,9.65,40,0.0),
	 (11072,50,16.25,22,0.0);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11072,64,33.25,130,0.0),
	 (11073,11,21.0,10,0.0),
	 (11073,24,4.5,20,0.0),
	 (11074,16,17.45,14,0.05),
	 (11075,2,19.0,10,0.15),
	 (11075,46,12.0,30,0.15),
	 (11075,76,18.0,2,0.15),
	 (11076,6,25.0,20,0.25),
...
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 ...
	 (11077,8,40.0,2,0.1),
	 (11077,10,31.0,1,0.0),
	 (11077,12,38.0,2,0.05),
	 (11077,13,6.0,4,0.0),
	 (11077,14,23.25,1,0.03);
INSERT INTO order_details (order_id,product_id,unit_price,quantity,discount) VALUES
	 (11077,16,17.45,2,0.03),
	 (11077,20,81.0,1,0.04),
	 (11077,23,9.0,2,0.0),
	 (11077,32,32.0,1,0.0),
	 (11077,39,18.0,2,0.05),
	 (11077,41,9.65,3,0.0),
...
INSERT INTO orders (order_id,customer_id,employee_id,order_date,required_date,shipped_date,ship_via,freight,ship_name,ship_address,ship_city,ship_region,ship_postal_code,ship_country) VALUES
	 ...
	 (10253,'HANAR',3,'2099-12-31','1996-07-24','1996-07-16',2,58.17,'Hanari Carnes','Rua do Paço, 67','Rio de Janeiro','RJ','05454-876','Brazil'),
	 (10256,'WELLI',3,'1996-07-15','1996-08-12','1996-07-17',2,0.0,'Wellington Importadora','Rua do Mercado, 12','Resende','SP','08737-363','Brazil'),
	 (10257,'HILAA',999,'1996-07-16','1996-08-13','1996-07-22',3,81.91,'HILARION-Abastos','Carrera 22 con Ave. Carlos Soublette #8-35','San Cristóbal','Táchira','5022','Venezuela'),
	 (10258,'ERNSH',1,'1996-07-17','1996-08-14','1996-07-23',1,-15.5,'Ernst Handel','Kirchgasse 6','Graz',NULL,'8010','Austria'),
	 (10259,'CENTC',NULL,'1996-07-18','1996-08-15','1996-07-25',3,3.25,'Centro comercial Moctezuma','Sierras de Granada 9993','México D.F.',NULL,'05022','Mexico'),
	 (10260,'OTTIK',NULL,'1996-07-19','1996-08-16','1996-07-29',1,55.09,'Ottilies Käseladen','Mehrheimerstr. 369','Köln',NULL,'50739','Germany'),
...
INSERT INTO orders (order_id,customer_id,employee_id,order_date,required_date,shipped_date,ship_via,freight,ship_name,ship_address,ship_city,ship_region,ship_postal_code,ship_country) VALUES
	 ...
	 (10248,'VINET',5,'1996-07-04','1996-08-01',NULL,3,32.38,'Vins et alcools Chevalier','59 rue de l''Abbaye','Reims',NULL,'51100','France'),
	 (10249,'TOMSP',6,'1996-07-05','1996-08-16',NULL,1,11.61,'Toms Spezialitäten','Luisenstr. 48','Münster',NULL,'44087','Germany');
INSERT INTO orders (order_id,customer_id,employee_id,order_date,required_date,shipped_date,ship_via,freight,ship_name,ship_address,ship_city,ship_region,ship_postal_code,ship_country) VALUES
	 (10255,'RICSU',9,'1996-07-12','1996-08-09','1996-07-15',3,148.33,'Richter Supermarkt','Starenweg 5','Genève',NULL,'1204','Switzerland'),
	 (9123,'ALFKI',1,'1996-07-05','1996-07-12',NULL,3,12.34,'Alfreds Futterkiste','Obere Str. 57','Berlin',NULL,'12209','Germany'),
	 (10250,'HANAR',4,'1996-07-08','1996-08-05','1996-07-12',2,65.83,'Hanari Carnes','Rua do Paço, 67','Rio de Janeiro','RJ','05454-876','Brazil'),
	 (10251,'VICTE',3,'1996-07-08','1996-08-05','1996-07-15',1,41.34,'Victuailles en stock','2, rue du Commerce','Lyon',NULL,'69004','France'),
	 (10252,'SUPRD',4,'1996-07-09','1996-08-06','1996-07-11',2,51.3,'Suprêmes délices','Boulevard Tirou, 255','Charleroi',NULL,'B-6000','Belgium'),
	 (10254,'CHOPS',5,'1996-07-11','1996-08-08','1996-07-23',2,22.98,'Chop-suey Chinese','Hauptstr. 31','Bern',NULL,'3012','Switzerland'),
...
INSERT INTO products (product_id,product_name,supplier_id,category_id,quantity_per_unit,unit_price,units_in_stock,units_on_order,reorder_level,discontinued) VALUES
	 ...
	 (3,'Aniseed Syrup 1L',1,99,'12 - 550 ml bottles',10.0,13,70,25,0),
	 (2,'PRxc',1,99,'24 - 12 oz bottles',19.0,17,40,25,1),
	 (1,'PRxc',8,99,'10 boxes x 30 bags',18.0,39,0,10,1),
	 (4,'Chef Anton''s Cajun Seasoning',2,2,'48 - 6 oz jars',22.0,53,0,0,0),
	 (5,'Chef Anton''s Gumbo Mix',2,2,'36 boxes',21.35,0,0,0,1),
	 (6,'Grandma''s Boysenberry Spread',3,2,'12 - 8 oz jars',25.0,120,0,25,0);
INSERT INTO products (product_id,product_name,supplier_id,category_id,quantity_per_unit,unit_price,units_in_stock,units_on_order,reorder_level,discontinued) VALUES
